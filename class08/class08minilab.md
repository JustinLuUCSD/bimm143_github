...
``` r
grep("mean", colnames(wisc.df), value = 1)
```
...
distance matrix as produced by the `dist()` funciton.
...
![](class08minilab_files/figure-commonmark/unnamed-chunk-16-1.png)
...
![](class08minilab_files/figure-commonmark/unnamed-chunk-17-1.png)
...
![](class08minilab_files/figure-commonmark/unnamed-chunk-20-1.png)
...
![](class08minilab_files/figure-commonmark/unnamed-chunk-22-1.png)
