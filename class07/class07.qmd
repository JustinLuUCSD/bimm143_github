...
The goal of PCA is to reduce the dimensionality of. adataset down to some smaller subset of new vairables (called PCs) that are a useful basis for further analysis, like visualization, clustering, etc.
...
Another important output from PCA is called the "loadings" vector or the "rotation" component - this tells us how much of the original variabes (the foods in this case) contribute to the new PCs.
```{r}
pca$rotation
```
